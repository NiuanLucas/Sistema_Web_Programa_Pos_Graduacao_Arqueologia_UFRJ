...
<div class="container">
  ...
  <div class="col col-12 mt-5 mb-5">
    ...
    <div class="row">
    <h3 class="h4 m-3 col-0"><i class="fas fa-file"></i> Páginas </h3>

    <a href='inserir_paginas.php' class="col-0">
      <button type='button' class='btn bg-dark text-white mt-3 ml-3'> <i class="fas fa-plus"></i> Inserir nova página</button>
    </a> 
  ...
  <table class="table table-responsive-md table-bordered table-hover mt-3 mb-3 border-0">
    ...
    <tbody>
      ...
      <tr>
            ...
            <a class="m-2" href='alterar_paginas.php?pg_id=<?php echo $linha["pagina_id"] ?>'><i class="fas fa-edit"></i> Editar </a>

            <a class="m-2" href='excluir_paginas.php?pg_id=<?php echo $linha["pagina_id"] ?>'><i class="fas fa-times"></i> Excluir </a>
