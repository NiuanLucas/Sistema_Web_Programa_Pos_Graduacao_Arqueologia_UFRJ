...
usuarios
        $operacao_excluir = musuariosonecta, $excluir);
        ...
        $usuario_id = $_GET["usr_id"];
          ...
          echo "<script> window.location.href = 'todos_usuarios.php'; </script>";
        ...
        $inusuariosmysqli_query($conecta, $usr_alterar);
