...
paginas
  //REMOVE TABLE
        ...
        $ID = $_POST["pagina_ipaginas

        $excluir = "DELETE FROM paginas ";

        $excluir .= "WHERE  pagina_id = {$ID} ";


paginas
        $operacao_excluir = mysqpaginasecta, $excluir);
...
<div class="container">
  ...
  <h3 class="h4 mt-3 mb-3"><i class="fas fa-users"></i> Excluir Página Fixa: 

    <?php echo $dados_pagina['pagina_titulo']; ?></h3>

  <hr class="my-2">



<form class="mt-4" action="excluir_paginas.php" method="post" accept-charset="utf-8">
  ...
  <div class="form-group d-none">
    ...
    value="<?php echo $dados_pagina['pagina_id']; ?>">
